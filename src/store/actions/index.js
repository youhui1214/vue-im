...
import {
    sendMsg, sendFileMsg, sendMsgReceipt, sendRobotMsg, revocateMsg, updateLocalMsg, getHistoryMsgs,
    resetNoMoreHistoryMsgs, continueRobotMsg
} from './msgs'
...
import {
    delegateTeamFunction, onTeamNotificationMsg, enterSettingPage, getTeamMembers, checkTeamMsgReceipt, getTeamMsgReads
} from './team'
